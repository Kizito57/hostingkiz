			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-success btn-block btn-sm col-sm-2 float-right" href="index.php?page=manage_product" id="new_product">
							...
							<tbody>
								...
								<tr data-id= '<?php echo $row['id'] ?>'>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-success edit_product" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
